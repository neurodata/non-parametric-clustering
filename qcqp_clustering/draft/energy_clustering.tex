...
\subsection*{Hartigan's Algorithm for Energy Statistics Clustering}
...
%One can see the better performance of energy statistics
...
Clustering the data shown in Fig.~\ref{fig:other} with Algorithms~\ref{algo}
and \ref{kmeans_algo}, besides $k$-means and GMM, for the kernels 
\eqref{eq:rhoalpha},
