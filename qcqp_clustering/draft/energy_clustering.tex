...
GMM/EM is unable to estimate the covariance matrices
...
and in particular it outperforms kernel $k$-means as the number
...
The optimal accuracy in these last cases is $1$.
}
\end{figure}
...
GMM/EM was unnable to estimate the covariance matrices
as dimensions get large. Algorithm~\ref{algo} outperforms
...
where we recall that both find approximate and local solutions
