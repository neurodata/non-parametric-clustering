...
comes from its mean and it is thus sensitive to outliers. Moreover, $k$-means
...
since there is no principled theory behind this, and it usually introduces
extra parameters that need to be optimized. The well-known
