...
Fig.~\ref{fig:1dexperiment}. We have two mixtures of normal and 
lognormal distributions. Notice that in the kernel density estimation plots
...
this one-dimensional example performed the same as the deterministic
...
\begin{tabular}{@{}l|ll|ll@{}}
       ...
       Method      & Accuracy & SEM     & Accuracy & SEM \\ \midrule[.5pt]
        kmeans       & 0.5330 & 0.0048  & 0.5210   & 0.0027 \\
         GMM         & 0.9292 & 0.0295  & 0.5330   & 0.0039 \\
 spectral clustering & 0.5775 & 0.0096  & 0.7253   & 0.0028 \\
    kernel k-means   & 0.9999 & 0.0002  & 0.9999   & $4.16\, 10^{-5}$ \\
   kernel k-groups   & 0.9987 & 0.0003  & 0.9999   & $4.16\, 10^{-5}$  
\end{tabular}
\end{table}
