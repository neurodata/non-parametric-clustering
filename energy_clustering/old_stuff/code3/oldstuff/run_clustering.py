...
def energy_lloyd(k, X, G, run_times=5, init="spectral"):
...
def kmeans(k, X, run_times=5, init='k-means++'):
...
def gmm(k, X, run_times=5, init='kmeans'):
...
def spectral(k, X, G, run_times=5):
